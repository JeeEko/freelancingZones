...
export class StatisticNamberService {
 ...
 UpdateStaticNumber(StatisticNumber:StatisticNumber):Observable<any>{
  ...
  return this.httpClient.put<any>(environment.ApiUri+'api/Products/',StatisticNumber,httpOption);
}
PostStaticNumber(StatisticNumber:StatisticNumber):Observable<any>{
  ...
  return this.httpClient.post<any>(environment.ApiUri+'api/Post/',StatisticNumber,httpOption);
}
PutStatistic(StatisticNumber:StatisticNumber):Observable<any>{
    ...
    return this.httpClient.put<any>(environment.ApiUri+'api/Put/',StatisticNumber,httpOption);
